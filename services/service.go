...
import (
	...
	"github.com/les-cours/payment-gateway/env"
	"github.com/les-cours/payment-gateway/graph"
	"github.com/les-cours/payment-gateway/graph/resolvers"
...
func Start() {
	...
	conn, err := grpc.Dial(env.Conf.PaymentService.Host+":"+env.Conf.PaymentService.Port, grpc.WithInsecure())
	if err != nil {
	...
	r := resolvers.Resolver{PaymentClient: paymentClient}
